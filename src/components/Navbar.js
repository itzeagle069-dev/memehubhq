...
export default function Navbar() {
    ...
    // Navbar logic updated to show on desktop reels
    ...
    return (
        <>
            <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-white/80 dark:bg-[#050505]/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800" : "bg-transparent border-transparent"} ${pathname?.startsWith('/reels') ? "hidden md:block" : ""}`}>
