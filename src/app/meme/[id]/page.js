...
export default function MemePage() {
    ...
    const [showDownloadPrep, setShowDownloadPrep] = useState(false);
    const [downloadPrepTimer, setDownloadPrepTimer] = useState(3);
    ...
    const handleDownload = async () => {
        ...
        // Show download preparation modal
        setShowDownloadPrep(true);
        setDownloadPrepTimer(3);

        // Start countdown
        const timer = setInterval(() => {
            setDownloadPrepTimer((prev) => {
                if (prev <= 1) {
                    clearInterval(timer);
                    // Start actual download
                    performDownload();
                    setShowDownloadPrep(false);
                    return 0;
                }
                return prev - 1;
            });
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#050505] text-black dark:text-white">
            {/* Header */}
            <div className="bg-white dark:bg-[#111] border-b border-gray-200 dark:border-[#222] fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-opacity-95 dark:bg-opacity-95">
            ...
            <div className="max-w-7xl mx-auto p-4 md:p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 pt-20">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {/* Ad Banner Above Actions */}
                    <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-[#252525] overflow-hidden shadow-lg">
                        <div className="min-h-[100px] bg-gray-50 dark:bg-black flex items-center justify-center">
                            <AdUnit type="banner" />
                        </div>
                    </div>

                    {/* Actions */}
                    <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-[#252525] p-6 shadow-lg">
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-2 overflow-hidden">
                            <div
                                ...
                                style={{ width: (((3 - downloadPrepTimer) / 3) * 100) + "%" }}
                            />
                        </div>
                        <p className="text-sm font-bold text-gray-400">
                            Starting in {downloadPrepTimer} seconds...
                        </p>
                    </div>
                </div>
            </div>
